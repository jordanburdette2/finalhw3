  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="newEmployeeModalLabel">New Job</h1>
      ...
      <div class="modal-body">
        <form method="post" action="">
            ...
            <div class="mb-3">
              <label for="offNum" class="form-label">Office Number</label>
              <input type="text" class="form-control" id="offNum" name="offNum">
            </div>
