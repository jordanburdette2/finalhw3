...
<h1>Employees with Jobs</h1>
  ...
  <div class="col-auto">
<?php
include "view-employees-with-jobs-newform.php";
?>
  </div>
</div>
...
?>
    ...
    <div class="row">
      <div class="col">
        <?php echo $job['job_number']; ?> - <?php echo $job['job_title']; ?> - <?php echo $job['start_date']; ?>
      </div>
      <div class="col-auto">
<?php
include "view-employees-with-jobs-editform.php";
?>
      </div>
      <div class="col-auto">
