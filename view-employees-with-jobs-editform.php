...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editDivisionModal<?php echo $job['division_id']; ?>">
...
<!-- Modal -->
<div class="modal fade" id="editDivisionModal<?php echo $job['division_id']; ?>" tabindex="-1" aria-labelledby="editDivisionModalLabel<?php echo $job['division_id']; ?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editDivisionModalLabel<?php echo $job['division_id']; ?>">Edit Division</h1>
